      ...
      >
        ...
        <div class="flex items-center justify-end w-full px-8 py-4 mt-8 bg-gray-100 border-t border-gray-200">
          <FormulateInput
            ...
            name="Create Event"
            :disabled="loading"
          >Create Event<div v-if="loading" style="border-top-color:transparent" class="ml-3 w-5 h-5 border-4 border-blue-400 border-solid rounded-full animate-spin"></div>
          </FormulateInput>
        </div>
      </FormulateForm>
    </div>
